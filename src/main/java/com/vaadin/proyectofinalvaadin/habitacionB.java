...
public class habitacionB extends VerticalLayout {
        ...
        public habitacionB() {
                ...
                for (int i = 1; i < 21; i++) {
                        String nombreHabitacion = "B"+i;        //Variable creada dentro de ciclo para poder que cada boton recuerde su número
                        ...
                        habitacion.addClickListener(e -> {
                                if (true /*TODO: Revisar que no esta llena la habitación en archivos */) {
                ...
                try {
                        agregar.addClickListener(e ->{
                                ...
                                if (dp == null || nombrePaciente.getValue().equals("")){
                                        ...
                                        //TODO: crear paciente nuevo recibes: nombrePacienteIZ, documentoPacienteIZ y nHabitacion
                                        Notification.show(nCama+" - "+" de "+nHabitacion+" ocupada correctamente");
                                        return;
                                        //TODO: falta que la cama se desactive cuando se agregue un usuario
                                }
                        });
                } catch (Exception e) {
                ...
                NumberField documentoPacienteIZ = new NumberField("Ingrese el documento");
                ...
                try {
                        agregarIZ.addClickListener(e ->{
                                ...
                                if (dp == null || nombrePacienteIZ.getValue().equals("")){
                                        Notification.show("Los campos no pueden estar vacío");
                                        return; 
                                }else if (!dp.matches("\\d*")&&(nombrePacienteIZ.getValue()).matches(REGEX)){
                                        Notification.show("No se permiten tildes ni caracteres especiales");
                                        return;
                                }else{
                                        gridHabitaciones.setVisible(true);
                                        ...
                                        //TODO: crear paciente nuevo recibes: nombrePacienteIZ, documentoPacienteIZ y nHabitacion
                                        Notification.show(nCamaIZ+" - "+" de "+nHabitacionIZ+" ocupada correctamente");
                                        return;
                                        //TODO: falta que la cama se desactive cuando se agregue un usuario
                                }
                        });
                ...
                gridDetallesIZ.add(tituloDetallesIZ, nombrePacienteIZ,documentoPacienteIZ,contenedorBotonesIZ);
