                ...
                try {
                        ...
                        agregar.addClickListener(e -> {
                                ...
                                if (dp.equals("null") || nombrePaciente.getValue().isEmpty()) {
                                        ...
                                        try {
                                                Procesos.registroPacientesHabitacionesA(nombrePaciente.getValue(), dp,
                                                                nHabitacion);

                                                Notification.show(
                                                                "Habitación " + nHabitacion + " ocupada correctamente");
                                                return;
                                        } catch (Exception E) {
                                                Notification.show("Paciente ya registrado");
                                        }
                        ...
                        Notification.show("Error de la base de datos");
                } catch (Exception e) {
